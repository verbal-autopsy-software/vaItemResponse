...
We first load a simulated dataset from the openVA package
...
Now we are ready to calculate the symptom importance metric. The first step is to reorganize the data and account for fixed dependence relationship between symptoms due to the skip patterns of the questionnaire, using the `get_skip_pattern` function. We then use the output and the `evaluate_symptom` to calculate the importance metric for a particular symptom.
